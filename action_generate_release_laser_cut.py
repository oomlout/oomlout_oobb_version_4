    ...
    for folder in folders:
        ...
        if os.path.isfile(file_laser_flat_source_svg):
            ...
            if os.path.isfile(json_file):
                ...
                #laser svg copy
                file_3dpr_destination = f"{folder_laser}/svg/{folder}.svg"
                #if source exists
                ...
                file_3dpr_navigation_svg = f"{folder_navigation}/{type}/width_{width}/height_{height}/{folder}.svg"
                file_3dpr_navigation_dxf = f"{folder_navigation}/{type}/width_{width}/height_{height}/{folder}.dxf"
