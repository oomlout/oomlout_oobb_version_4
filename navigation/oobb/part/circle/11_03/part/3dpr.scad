		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 11) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_circle_shape_p_type_3_depth_11_diameter_3_thickness_11_width_11_height", valign = "center");
				}
			}
		}
		cylinder(h = 3, r = 82.0000000000);
	}
	union() {
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 7, 0]) {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 11) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_11_diameter_3_thickness_11_width_11_height_true_both_holes_true_circle", valign = "center");
				}
			}
		}
