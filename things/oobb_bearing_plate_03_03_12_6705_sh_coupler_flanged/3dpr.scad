...
difference() {
	union() {
			...
			rotate(a = [180, 0, 0]) {
				difference() {
					...
					union() {
						...
						translate(v = [5.6570000000, 5.6570000000, 6.0000000000]) {
							rotate(a = [0, 0, 0]) {
								difference() {
									union() {
										...
										translate(v = [0, 0, -22.0000000000]) {
											cylinder(h = 22, r = 1.5000000000);
										}
										translate(v = [0, 0, -1.9000000000]) {
											cylinder(h = 1.9000000000, r1 = 1.8000000000, r2 = 3.6000000000);
										}
										translate(v = [0, 0, -22.0000000000]) {
											cylinder(h = 22, r = 1.8000000000);
										}
										translate(v = [0, 0, -22.0000000000]) {
											cylinder(h = 22, r = 1.5000000000);
										}
		...
		translate(v = [105, 0, 0.0000000000]) {
	...
	union() {
		...
		translate(v = [110.6570000000, 5.6570000000, 0]) {
		...
		translate(v = [99.3430000000, -5.6570000000, 0]) {
			rotate(a = [0, 0, 15.0000000000]) {
				difference() {
					union() {
						translate(v = [-1.8000000000, -3.0000000000, -0.3000000000]) {
		...
		translate(v = [105, 0, -50.0000000000]) {
