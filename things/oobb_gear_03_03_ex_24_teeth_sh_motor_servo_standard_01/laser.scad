...
difference() {
	union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 1) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description gear_shape_p_type_3_depth_3_diameter_3_thickness_24_teeth_extra_motor_servo_standard_01_shaft_0.53333333_diametral_pitch_24_number_of_teeth", valign = "center");
				}
			}
		}
	...
	union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 3) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_3_diameter_3_thickness_24_teeth_extra_motor_servo_standard_01_shaft_3_width_3_height_true_both_holes_true_circle_false_middle", valign = "center");
				}
			}
		}
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 2]) {
				rotate(a = [0, 0, 45]) {
					linear_extrude(height = 1) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_motor_servo_standard_01_shape_n_type_0_0_2_pos_3_diameter_3_thickness_motor_servo_standard_01_shaft_shaft_part_0_0_45_rot_false_overhang", valign = "center");
					}
				}
			}
		}
