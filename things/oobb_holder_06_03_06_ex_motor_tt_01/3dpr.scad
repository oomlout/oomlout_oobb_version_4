...
difference() {
	...
	union() {
		...
		translate(v = [8.0000000000, -18.0000000000, 9.0000000000]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [8.0000000000, -4.0000000000, 9.0000000000]) {
				linear_extrude(height = 3) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_screw_countersunk_shape_n_type_m3_radius_name_12_depth_8.0_-18.0_9.0_pos_motor_tt_01_extra_6_width_3_height_12_thickness_6705_bearing_0_0_0_rot_true_nut_true_overhang", valign = "center");
				}
			}
		}
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [-8.0000000000, 32.0000000000, 9.0000000000]) {
				linear_extrude(height = 3) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_screw_countersunk_shape_n_type_m3_radius_name_12_depth_-8.0_18.0_9.0_pos_motor_tt_01_extra_6_width_3_height_12_thickness_6705_bearing_0_0_0_rot_true_nut_true_overhang", valign = "center");
				}
			}
		}
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [-8.0000000000, -4.0000000000, -3.0000000000]) {
				rotate(a = [0, 180, 0]) {
					linear_extrude(height = 3) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_screw_countersunk_shape_n_type_m3_radius_name_12_depth_-8.0_-18.0_-3.0_pos_motor_tt_01_extra_6_width_3_height_12_thickness_6705_bearing_0_180_0_rot_true_nut_true_overhang", valign = "center");
					}
				}
			}
		}
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [8.0000000000, 32.0000000000, -3.0000000000]) {
				rotate(a = [0, 180, 0]) {
					linear_extrude(height = 3) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_screw_countersunk_shape_n_type_m3_radius_name_12_depth_8.0_18.0_-3.0_pos_motor_tt_01_extra_6_width_3_height_12_thickness_6705_bearing_0_180_0_rot_true_nut_true_overhang", valign = "center");
					}
				}
			}
		}
