...
difference() {
	...
	union() {
		translate(v = [-11.2500000000, -37.5000000000, 2]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
		...
		translate(v = [0, 0, 3]) {
			hull() {
				union() {
					translate(v = [-13.2500000000, 39.5000000000, 4]) {
						cylinder(h = 102, r = 4);
					}
					translate(v = [-13.2500000000, 39.5000000000, 4]) {
						sphere(r = 4);
					}
					translate(v = [-13.2500000000, 39.5000000000, 106]) {
						sphere(r = 4);
					}
				}
				union() {
		...
		translate(v = [-33.7500000000, -37.5000000000, 22.5000000000]) {
			rotate(a = [0, 90, 0]) {
