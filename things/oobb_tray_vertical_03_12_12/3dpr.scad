...
difference() {
	union() {
		hull() {
			translate(v = [-17.0000000000, 84.5000000000, 0]) {
				cylinder(h = 12, r = 5);
			}
			translate(v = [17.0000000000, 84.5000000000, 0]) {
				cylinder(h = 12, r = 5);
	...
	union() {
		...
		translate(v = [-37.5000000000, -82.5000000000, 22.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 3.2500000000);
			}
		}
		translate(v = [-37.5000000000, -67.5000000000, 22.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 3.2500000000);
			}
		}
		translate(v = [-37.5000000000, -52.5000000000, 22.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 3.2500000000);
			}
		}
		translate(v = [-37.5000000000, -37.5000000000, 22.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 3.2500000000);
			}
		}
