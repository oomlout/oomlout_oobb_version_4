...
difference() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 5) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_circle_shape_p_type_3_depth_5_diameter_3_thickness_coupler_flanged_shaft_5_width_5_height", valign = "center");
				}
			}
		}
	...
	union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 5) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_5_diameter_3_thickness_coupler_flanged_shaft_5_width_5_height_true_both_holes_true_circle_false_middle", valign = "center");
				}
			}
		}
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 1) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_coupler_flanged_shape_n_type_5_diameter_3_thickness_coupler_flanged_shaft_shaft_part", valign = "center");
				}
			}
		}
	}
