...
difference() {
	...
	union() {
				...
				difference() {
					union() {
						...
						#translate(v = [0, 0, -0.7500000000]) {
							cylinder(h = 0.7500000000, r1 = 1.1000000000, r2 = 2.5000000000);
						}
						#translate(v = [0, 0, -9.0000000000]) {
							cylinder(h = 9, r = 1.1000000000);
						}
						#translate(v = [0, 0, -9.0000000000]) {
							cylinder(h = 9, r = 1.0000000000);
						}
		...
		translate(v = [23.5000000000, 13.2500000000, -50.0000000000]) {
			cylinder(h = 100, r = 1.1000000000);
		}
		translate(v = [-23.5000000000, 13.2500000000, -50.0000000000]) {
			cylinder(h = 100, r = 1.1000000000);
		}
		translate(v = [23.5000000000, 1.7500000000, -50.0000000000]) {
			cylinder(h = 100, r = 1.1000000000);
		}
		translate(v = [-23.5000000000, 1.7500000000, -50.0000000000]) {
			cylinder(h = 100, r = 1.1000000000);
