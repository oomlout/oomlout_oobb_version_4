...
difference() {
	union() {
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, -6]) {
				linear_extrude(height = 3) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_plate_shape_positive_type_6_depth_0_0_-6_pos_motor_extra_6_thickness_2_width_3_height_0_0_-6_pos_plate", valign = "center");
				}
			}
		}
		translate(v = [0, 0, -6]) {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, -6]) {
				linear_extrude(height = 3) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_p_type_0_0_-6_pos_motor_extra_6_thickness_2_width_3_height_0_0_-6_pos_plate_'left'_'right'_hole_sides_'left'_'right'_holes_true_both_holes", valign = "center");
				}
			}
		}
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [-7.5000000000, 14, -3]) {
				rotate(a = [0, 0, 180]) {
					linear_extrude(height = 3) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_wire_motor_shape_-7.5_0_-3_pos_motor_extra_6_thickness_2_width_3_height_0_0_-6_pos_plate_0_0_180_rot", valign = "center");
					}
				}
			}
		}
