				...
				difference() {
					union() {
						...
						*color(alpha = 1.0000000000, c = "gray") {
							translate(v = [0, 14, 0]) {
								linear_extrude(height = 1) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description gear_shape_p_type_3_depth_9_diameter_3_thickness_72_teeth_extra_m3_shaft_0.53333333_diametral_pitch_72_number_of_teeth", valign = "center");
								}
							}
						}
					...
					union() {
						...
						*color(alpha = 1.0000000000, c = "gray") {
							translate(v = [0, 14, 0]) {
								linear_extrude(height = 9) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_9_diameter_3_thickness_72_teeth_extra_m3_shaft_9_width_9_height_true_both_holes_true_circle_false_middle", valign = "center");
								}
							}
						}
						...
						*color(alpha = 1.0000000000, c = "gray") {
							translate(v = [0, 14, 0]) {
								linear_extrude(height = 1) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_hole_shape_n_type_m3_radius_name_9_diameter_3_thickness_72_teeth_extra_m3_shaft", valign = "center");
								}
							}
						}
