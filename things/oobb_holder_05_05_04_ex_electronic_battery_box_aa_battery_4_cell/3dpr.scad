					...
					union() {
						...
						translate(v = [31.5000000000, 15, 0]) {
							rotate(a = [0, 0, 180]) {
								difference() {
									union() {
										translate(v = [23.0670000000, 1.0000000000, -3]) {
											cube(size = [5, 3.0800000000, 3]);
										}
										translate(v = [0.2040000000, -2.6900000000, -3]) {
											cube(size = [6.3000000000, 7.9200000000, 3]);
										}
										translate(v = [8.8880000000, -0.1500000000, -3]) {
											cube(size = [14.3000000000, 5.3800000000, 3]);
										}
										translate(v = [6.3500000000, -5.2300000000, -3]) {
											cube(size = [2.8400000000, 13.0000000000, 3]);
										}
										translate(v = [25.0440000000, -5.0000000000, -3]) {
											cube(size = [7, 10, 3]);
										}
										translate(v = [0.5000000000, -15, -1.5000000000]) {
