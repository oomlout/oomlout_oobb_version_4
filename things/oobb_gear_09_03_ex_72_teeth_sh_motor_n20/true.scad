		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 9) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_9_diameter_3_thickness_72_teeth_extra_motor_n20_shaft_9_width_9_height_true_both_holes_true_circle", valign = "center");
				}
			}
		}
