...
difference() {
	union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 1) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description gear_shape_p_type_9_depth_9_diameter_9_thickness_72_teeth_extra_m6_grubscrew_m3_shaft_0.53333333_diametral_pitch_72_number_of_teeth", valign = "center");
				}
			}
		}
		gear(backlash = 0.5000000000, bore_diameter = 0, circles = 0, circular_pitch = false, clearance = 0.5000000000, diametral_pitch = 0.5333333300, flat = false, gear_thickness = 9, hub_diameter = 0, hub_thickness = 0, involute_facets = 0, number_of_teeth = 72, pressure_angle = 20, rim_thickness = 9, rim_width = 0, twist = 0);
	}
	union() {
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 7, 0]) {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 9) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_9_diameter_9_thickness_72_teeth_extra_m6_grubscrew_m3_shaft_9_width_9_height_true_both_holes_true_circle_false_middle", valign = "center");
				}
			}
		}
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 1) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_hole_shape_n_type_m6_radius_name_9_diameter_9_thickness_72_teeth_extra_m6_grubscrew_m3_shaft", valign = "center");
				}
			}
		}
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 4.5000000000]) {
				rotate(a = [0, 90, 45]) {
					linear_extrude(height = 1) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_hole_shape_n_type_m3_radius_name_100_depth_0_0_4.5_pos_9_diameter_9_thickness_72_teeth_extra_m6_grubscrew_m3_shaft_0_90_45_rot", valign = "center");
					}
				}
			}
		}
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [3, 17, 4.5000000000]) {
				rotate(a = [0, 90, 45]) {
					linear_extrude(height = 1) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_nut_shape_n_type_m3_radius_name_3_3_4.5_pos_9_diameter_9_thickness_m6_grubscrew_m3_shaft_0_90_45_rot", valign = "center");
					}
				}
			}
		}
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [3, 17, 7.5000000000]) {
				rotate(a = [0, 90, 45]) {
					linear_extrude(height = 1) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_nut_shape_n_type_m3_radius_name_3_3_7.5_pos_9_diameter_9_thickness_m6_grubscrew_m3_shaft_0_90_45_rot", valign = "center");
					}
				}
			}
		}
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [3, 17, 10.5000000000]) {
				rotate(a = [0, 90, 45]) {
					linear_extrude(height = 1) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_nut_shape_n_type_m3_radius_name_3_3_10.5_pos_9_diameter_9_thickness_m6_grubscrew_m3_shaft_0_90_45_rot", valign = "center");
					}
				}
			}
		}
