...
difference() {
	...
	union() {
		translate(v = [0.0000000000, -75.0000000000, 3]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
		...
		translate(v = [-22.5000000000, -75.0000000000, 22.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 3.2500000000);
			}
		}
		translate(v = [-22.5000000000, -60.0000000000, 22.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 3.2500000000);
			}
		}
		translate(v = [-22.5000000000, -45.0000000000, 22.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 3.2500000000);
			}
		}
