...
difference() {
	union() {
		...
		translate(v = [60, 14, 7.5000000000]) {
			rotate(a = [0, 180, 0]) {
				difference() {
					union();
					union();
		...
		translate(v = [60, 0, 7.5000000000]) {
			rotate(a = [0, 180, 0]) {
				difference() {
					union() {
						*color(alpha = 1.0000000000, c = "blue") {
							translate(v = [-15, 14, 16.5000000000]) {
								linear_extrude(height = 3) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_p_type_m6_radius_name_-15_0_0_pos_motor_servo_standard_01_all_print_extra_5_width_3_height_0_thickness_9_thickness_top_15_thickness_middle_24_thickness_bottom_40_screw_bottom_length_6_screw_bottom_middle_single_holes_1_1_1_2_1_3_2_1_2_3_3_1_3_3_5_1_5_3_loc", valign = "center");
								}
							}
						...
						*color(alpha = 1.0000000000, c = "blue") {
							translate(v = [-15, 14, -7.5000000000]) {
								linear_extrude(height = 3) {
					...
					union() {
						translate(v = [0, 18, 28.5000000000]) {
							rotate(a = [0, 180, 0]) {
								difference() {
									union() {
										cylinder(h = 26, r = 1.5000000000);
						...
						translate(v = [8, 18, 28.5000000000]) {
							rotate(a = [0, 180, 0]) {
								difference() {
									union() {
										cylinder(h = 26, r = 1.5000000000);
						...
						*color(alpha = 1.0000000000, c = "blue") {
							translate(v = [0, 14, 16.5000000000]) {
								linear_extrude(height = 3) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_hole_shape_n_type_motor_servo_standard_01_all_print_extra_5_width_3_height_0_thickness_9_thickness_top_15_thickness_middle_24_thickness_bottom_40_screw_bottom_length_6_screw_bottom_middle_13.0_radius", valign = "center");
								}
							}
						...
						*color(alpha = 1.0000000000, c = "blue") {
							translate(v = [0, 32, 28.5000000000]) {
								linear_extrude(height = 3) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_screw_socket_cap_shape_n_type_m3_radius_name_26_depth_0_18_12_pos_motor_servo_standard_01_all_print_extra_5_width_3_height_0_thickness_9_thickness_top_15_thickness_middle_24_thickness_bottom_40_screw_bottom_length_6_screw_bottom_middle_true_nut_180_rot_y_bottom_zz_top_clearance_true_overhang", valign = "center");
								}
							}
						...
						*color(alpha = 1.0000000000, c = "blue") {
							translate(v = [8, 32, 28.5000000000]) {
								linear_extrude(height = 3) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_screw_socket_cap_shape_n_type_m3_radius_name_26_depth_8_18_12_pos_motor_servo_standard_01_all_print_extra_5_width_3_height_0_thickness_9_thickness_top_15_thickness_middle_24_thickness_bottom_40_screw_bottom_length_6_screw_bottom_middle_true_nut_180_rot_y_bottom_zz_top_clearance_true_overhang", valign = "center");
								}
							}
