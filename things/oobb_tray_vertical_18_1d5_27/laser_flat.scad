		...
		projection() {
			intersection() {
				...
				difference() {
					union() {
						hull() {
							translate(v = [-130.0000000000, 6.2500000000, 0]) {
								cylinder(h = 27, r = 5);
							}
							translate(v = [130.0000000000, 6.2500000000, 0]) {
								cylinder(h = 27, r = 5);
					...
					union() {
						translate(v = [-127.5000000000, -3.7500000000, 2]) {
							rotate(a = [0, 0, 0]) {
								difference() {
									union() {
						...
						translate(v = [0, 0, 3]) {
							hull() {
								union() {
									translate(v = [-129.5000000000, 5.7500000000, 4]) {
										cylinder(h = 39, r = 4);
									}
									translate(v = [-129.5000000000, 5.7500000000, 4]) {
										sphere(r = 4);
									}
									translate(v = [-129.5000000000, 5.7500000000, 43]) {
										sphere(r = 4);
									}
								}
								union() {
						...
						translate(v = [-150.0000000000, -3.7500000000, 22.5000000000]) {
							rotate(a = [0, 90, 0]) {
