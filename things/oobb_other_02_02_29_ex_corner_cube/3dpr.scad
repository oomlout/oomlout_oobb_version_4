	...
	union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 21.5000000000, 0]) {
				rotate(a = [0, 90, 0]) {
					linear_extrude(height = 2) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_hole_new_shape_n_type_m3_radius_name_0_7.5_0_pos_corner_cube_extra_2_width_2_height_29_thickness_middle_zz_0_90_0_rot", valign = "center");
					}
				}
			}
		}
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [-7.5000000000, 14, 0]) {
				linear_extrude(height = 2) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_hole_new_shape_n_type_m3_radius_name_-7.5_0_0_pos_corner_cube_extra_2_width_2_height_29_thickness_middle_zz_0_0_0_rot", valign = "center");
				}
			}
		}
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, -7.5000000000]) {
				rotate(a = [90, 0, 0]) {
					linear_extrude(height = 2) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_hole_new_shape_n_type_m3_radius_name_0_0_-7.5_pos_corner_cube_extra_2_width_2_height_29_thickness_middle_zz_90_0_0_rot", valign = "center");
					}
				}
			}
		}
