...
difference() {
	union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
		...
		gear(backlash = 1, bore_diameter = 0, circles = 0, circular_pitch = false, clearance = 1, diametral_pitch = 0.5333333300, flat = false, gear_thickness = 6, hub_diameter = 0, hub_thickness = 0, involute_facets = 0, number_of_teeth = 40, pressure_angle = 28, rim_thickness = 6, rim_width = 0, twist = 0);
	}
	union() {
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 7, 0]) {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [0, 14, 0]) {
				linear_extrude(height = 5) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_5_diameter_6_thickness_40_teeth_extra_5_width_5_height_true_both_holes_true_circle", valign = "center");
				}
			}
		}
