	...
	union() {
		...
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [5.3030000000, 19.3030000000, 6.0000000000]) {
				linear_extrude(height = 3) {
					text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_screw_countersunk_shape_n_type_m3_radius_name_12_depth_5.303_5.303_6.0_pos_3_width_3_height_12_thickness_6704_bearing_motor_servo_standard_01_shaft_horn_adapter_printed_extra_0_0_0_rot_true_nut_true_overhang", valign = "center");
				}
			}
		}
		*color(alpha = 1.0000000000, c = "gray") {
			translate(v = [-5.3030000000, 8.6970000000, -6.0000000000]) {
				rotate(a = [0, 180, 0]) {
					linear_extrude(height = 3) {
						text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_screw_countersunk_shape_n_type_m3_radius_name_12_depth_-5.303_-5.303_-6.0_pos_3_width_3_height_12_thickness_6704_bearing_motor_servo_standard_01_shaft_horn_adapter_printed_extra_0_180_0_rot_true_nut_true_overhang", valign = "center");
					}
				}
			}
		}
