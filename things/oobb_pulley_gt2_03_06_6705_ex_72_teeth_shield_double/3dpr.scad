...
difference() {
	union() {
		*color(alpha = 1.0000000000, c = "gray") {
		...
		translate(v = [0, 0, 1]) {
			pulley_gt2(depth = 16.0000000000, number_of_teeth = 72);
		}
	...
	union() {
		translate(v = [12.7280000000, 12.7280000000, 16.0000000000]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
						...
						#translate(v = [0, 0, -18.0000000000]) {
							cylinder(h = 18.0000000000, r = 1.5000000000);
						}
						#translate(v = [0, 0, -1.9000000000]) {
							cylinder(h = 1.9000000000, r1 = 1.8000000000, r2 = 3.6000000000);
						}
						#translate(v = [0, 0, -18.0000000000]) {
							cylinder(h = 18.0000000000, r = 1.8000000000);
						}
						#translate(v = [0, 0, -18.0000000000]) {
							cylinder(h = 18.0000000000, r = 1.5000000000);
						}
		...
		translate(v = [12.7280000000, -12.7280000000, 0]) {
			rotate(a = [0, 180, 0]) {
				difference() {
					union() {
						translate(v = [0, 0, -18.0000000000]) {
		...
		translate(v = [-250, -250, 8.0000000000]) {
