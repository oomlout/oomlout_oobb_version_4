...
difference() {
	union() {
		...
		translate(v = [41.0000000000, 36.5000000000, 0]) {
			cylinder(h = 9, r = 3.0500000000);
		}
		translate(v = [-41.0000000000, 36.5000000000, 0]) {
			cylinder(h = 9, r = 3.0500000000);
		}
		translate(v = [41.0000000000, -21.5000000000, 0]) {
			cylinder(h = 9, r = 3.0500000000);
		}
		translate(v = [-41.0000000000, -21.5000000000, 0]) {
			cylinder(h = 9, r = 3.0500000000);
	...
	union() {
		...
		translate(v = [41.0000000000, 36.5000000000, -50.0000000000]) {
			cylinder(h = 100, r = 1.8000000000);
		}
		translate(v = [-41.0000000000, 36.5000000000, -50.0000000000]) {
			cylinder(h = 100, r = 1.8000000000);
		}
		translate(v = [41.0000000000, -21.5000000000, -50.0000000000]) {
			cylinder(h = 100, r = 1.8000000000);
		}
		translate(v = [-41.0000000000, -21.5000000000, -50.0000000000]) {
			cylinder(h = 100, r = 1.8000000000);
