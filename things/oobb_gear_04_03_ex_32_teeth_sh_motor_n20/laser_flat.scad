						...
						*color(alpha = 1.0000000000, c = "gray") {
							translate(v = [0, 14, 0]) {
								linear_extrude(height = 4) {
									text(font = "Arial:style=Bold", halign = "center", size = 4.5000000000, text = "COMMENT description oobb_holes_shape_n_type_3.5_diameter_3_thickness_32_teeth_extra_motor_n20_shaft_4_width_4_height_true_both_holes_true_circle", valign = "center");
								}
							}
						}
